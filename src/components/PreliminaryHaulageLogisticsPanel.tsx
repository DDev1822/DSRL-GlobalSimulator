...
type Field = keyof Pick<PreliminaryHaulageRouteDefinition,'loadedDistanceKm'|'emptyDistanceKm'|'averageLoadedGradePercent'|'rollingResistancePercent'|'loadedSpeedKph'|'emptySpeedKph'|'loadingMinutes'|'dumpingMinutes'|'spottingMinutes'|'fixedDelayMinutes'|'payloadTonnes'|'truckCount'|'availability'|'utilization'|'operatingHoursPerPeriod'|'fuelBurnLitersPerTruckHour'|'fuelPriceUsdPerLiter'|'maintenanceCostUsdPerTruckHour'|'tireCostUsdPerTruckHour'|'otherCostUsdPerTruckHour'>;
...
export default function PreliminaryHaulageLogisticsPanel() {
  ...
  return <aside className="haulage-logistics-panel">
    ...
    <section className="haulage-route-editor"><header><div><strong>{route.label}</strong><small>{route.sourceDestination} · SUPUESTO DSRL</small></div></header><div className="haulage-input-grid">
      {field('Dist. cargado km','loadedDistanceKm',route.loadedDistanceKm,.1)}{field('Dist. vacío km','emptyDistanceKm',route.emptyDistanceKm,.1)}{field('Pendiente media %','averageLoadedGradePercent',route.averageLoadedGradePercent,.1)}{field('RR %','rollingResistancePercent',route.rollingResistancePercent,.1)}{field('Vel. cargado km/h','loadedSpeedKph',route.loadedSpeedKph,1)}{field('Vel. vacío km/h','emptySpeedKph',route.emptySpeedKph,1)}{field('Payload t','payloadTonnes',route.payloadTonnes,10)}{field('Camiones','truckCount',route.truckCount,1)}{field('Disponibilidad %','availability',route.availability,1,100)}{field('Utilización %','utilization',route.utilization,1,100)}{field('Horas/periodo','operatingHoursPerPeriod',route.operatingHoursPerPeriod,100)}{field('Carguío min','loadingMinutes',route.loadingMinutes,.1)}{field('Descarga min','dumpingMinutes',route.dumpingMinutes,.1)}{field('Posicionamiento min','spottingMinutes',route.spottingMinutes,.1)}{field('Demora fija min','fixedDelayMinutes',route.fixedDelayMinutes,.1)}{field('Consumo L/h','fuelBurnLitersPerTruckHour',route.fuelBurnLitersPerTruckHour,5)}{field('Combustible US$/L','fuelPriceUsdPerLiter',route.fuelPriceUsdPerLiter,.05)}{field('Mantenimiento US$/h','maintenanceCostUsdPerTruckHour',route.maintenanceCostUsdPerTruckHour,5)}{field('Neumáticos US$/h','tireCostUsdPerTruckHour',route.tireCostUsdPerTruckHour,5)}{field('Otros US$/h','otherCostUsdPerTruckHour',route.otherCostUsdPerTruckHour,5)}
    </div></section>
